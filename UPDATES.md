...
Second phase:
-- 
- we can also store a record of provider reputation for each article (new table) 
- consider adding another agent to critique the story and the images and improve them.
