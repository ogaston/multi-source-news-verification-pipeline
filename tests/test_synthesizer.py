...
from agents.synthesizer import FINAL_ARTICLE_MAX_CHARS, SYSTEM_PROMPT, run
...
def test_run_does_not_hard_truncate_long_output():
    ...
    with patch("agents.synthesizer.invoke_llm", return_value=long_article) as mock_llm:
